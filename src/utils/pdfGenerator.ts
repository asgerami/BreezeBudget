...
export const generatePDFReport = async (
  ...
  pdf.setFont("helvetica", "bold");
  pdf.setFontSize(20);
  pdf.text("Breeze-Budget Report", margin, y);
  ...
  pdf.setFont("helvetica", "normal");
  pdf.setFontSize(8);
  pdf.text("Generated by Breeze-Budget", margin, bottomBarrier + 6);
  pdf.text(
  ...
  pdf.text(
    "For questions, contact your HVAC professional or visit breeze-budget.com.",
    margin,
    bottomBarrier + 18
  );
  ...
  const fileName = `BreezeBudget_Report_${location}_${inputs.selectedUnit?.brand}_${date}.pdf`;
  pdf.save(fileName);
};
